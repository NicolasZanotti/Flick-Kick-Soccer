package soccer.socket
{
	...
	/**
	 * @author Simeon Bateman, Nicolas Zanotti
	 * @see https://github.com/simb/FlashSocket.IO
	 */
	public class FlashSocket extends EventDispatcher implements IWebSocketWrapper
	{
		...
		{
			return (URLUtil.getProtocol(this.callerUrl) + "://" + URLUtil.getServerNameWithPort(this.callerUrl)).toLowerCase();
		}
